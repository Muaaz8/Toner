    ...
    <div class="modal-dialog modal-lg ">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div>
            <h3 class="text-center mb-3">Size Guide</h3>
            <div>
              <div>
                <ul class="size_guide_ul" id="myTab" role="tablist">
                ...
                <div class="tab-content" id="myTabContent">
                  ...
                  >
                    <div>
                      <table class="table table_main__">
                        <thead>
                          <tr>
                            <th>SIZE</th>
                            <th>CHEST</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colSpan="4" class="last_td_main">
                              <div>
                                <p class="measure">
